...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_assets_constraints_group_time" ON "assets_constraints" ("group_id","time_period");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bom_name" ON "bom" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bom_end_product" ON "bom" ("end_product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bom_byproducts_bom_id" ON "bom_byproducts" ("bom_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bom_byproducts_product_id" ON "bom_byproducts" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bom_components_bom_id" ON "bom_components" ("bom_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bom_components_product_id" ON "bom_components" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_cash_accounts_facility_currency" ON "cash_accounts" ("facility_id","currency");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_cog_location_name" ON "cog_new_locations" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_cog_location_city" ON "cog_new_locations" ("city");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_cog_location_country" ON "cog_new_locations" ("country");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_cog_location_lat_long" ON "cog_new_locations" ("latitude","longitude");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_custom_constraints_left_hand_side" ON "custom_constraints" ("left_hand_side");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_custom_constraints_right_hand_side" ON "custom_constraints" ("right_hand_side");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_custom_constraints_comparison_type" ON "custom_constraints" ("comparison_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_custom_constraints_constraint_type" ON "custom_constraints" ("constraint_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_demand_customer_product_inclusion" ON "demand" ("customer_id","product_id","inclusion_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_demand_coverage_by_distance_site" ON "demand_coverage_by_distances" ("site_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_demand_fulfillment_customer" ON "demand_fulfillment" ("customer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_demand_fulfillment_product" ON "demand_fulfillment" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_demand_fulfillment_iteration" ON "demand_fulfillment" ("iteration");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_demand_fulfillment_period" ON "demand_fulfillment" ("period");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_distance_coverage_by_demand_site" ON "distance_coverage_by_demands" ("site_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_facilities_name_inclusion_type" ON "facilities" ("name","inclusion_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_facility_expenses_facility_type" ON "facility_expenses" ("facility_id","expense_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_if_condition_id" ON "indicator_constraints" ("if_condition_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_then_condition_id" ON "indicator_constraints" ("then_condition_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_linear_ranges_name" ON "linear_ranges" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_group_id" ON "location_group_locations" ("location_group_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_id" ON "location_group_locations" ("location_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_group_name" ON "location_groups" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_name" ON "locations" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_city" ON "locations" ("city");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_country" ON "locations" ("country");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_location_lat_long" ON "locations" ("latitude","longitude");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idx_location_name_country" ON "locations" ("name","country");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_objective_members_name_inclusion" ON "objective_members" ("name","inclusion_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_paths_from_location" ON "paths" ("from_location");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_paths_to_location" ON "paths" ("to_location");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_paths_cost_calculation_policy" ON "paths" ("cost_calculation_policy");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_paths_vehicle_type_id" ON "paths" ("vehicle_type_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_period_groups_name" ON "period_groups" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "periods_name_idx" ON "periods" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "periods_start_end_idx" ON "periods" ("start","end");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_processing_costs_facility_product" ON "processing_costs" ("facility_id","product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_processing_costs_type" ON "processing_costs" ("type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_processing_costs_currency" ON "processing_costs" ("currency");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_processing_costs_units" ON "processing_costs" ("units");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_processing_costs_time_period" ON "processing_costs" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_flows_source_dest" ON "product_flows" ("source_id","destination_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_flows_vehicle_type" ON "product_flows" ("vehicle_type_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_flows_product" ON "product_flows" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_flows_time_period" ON "product_flows" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_flows_inclusion_type" ON "product_flows" ("inclusion_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_group_id" ON "product_group_products" ("product_group_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_id" ON "product_group_products" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_group_name" ON "product_groups" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_storages_label" ON "product_storages" ("label");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_storages_facility" ON "product_storages" ("facility_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_storages_product" ON "product_storages" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_storages_time_period" ON "product_storages" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_product_storages_inclusion_type" ON "product_storages" ("inclusion_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_label" ON "production" ("label");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_site" ON "production" ("site_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_product" ON "production" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_time_period" ON "production" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_label_no" ON "production_no" ("label");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_site_no" ON "production_no" ("site_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_product_no" ON "production_no" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_bom_no" ON "production_no" ("bom_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_production_time_period_no" ON "production_no" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sale_batches_source" ON "sale_batches" ("source_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sale_batches_product" ON "sale_batches" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sale_batches_time_period" ON "sale_batches" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_site_state_changes_site" ON "site_state_changes" ("site_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_site_state_changes_time_period" ON "site_state_changes" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sourcing_product_id" ON "sourcing" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sourcing_time_period_id" ON "sourcing" ("time_period_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sourcing_delivery_destination" ON "sourcing" ("delivery_destination");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_supplier_products_supplier_id" ON "supplier_products" ("supplier_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_supplier_products_product_id" ON "supplier_products" ("product_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "unique_conversion" ON "unit_conversions" ("product_id","unit_from","unit_to");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_unit_conversions_product_id" ON "unit_conversions" ("product_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_unit_conversions_unit_from" ON "unit_conversions" ("unit_from");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_unit_conversions_unit_to" ON "unit_conversions" ("unit_to");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_units_name" ON "units" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_vehicle_types_name" ON "vehicle_types" ("name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_vehicle_types_capacity_unit" ON "vehicle_types" ("capacity_unit");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_vehicle_types_speed_unit" ON "vehicle_types" ("speed_unit");